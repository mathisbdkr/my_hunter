...
sfSprite *set_game_over(struct hunter_t *hunter)
{
	...
	sfSprite_setTexture(game_over, sfTexture_createFromFile("img/game_over.png", NULL), 0);
...
sfSprite *set_retry(struct hunter_t *hunter)
{
	...
	sfSprite_setTexture(retry, sfTexture_createFromFile("img/retry.png", NULL), 0);
    hunter->retry = retry;
}
...
sfSprite *set_quit(struct hunter_t *hunter)
{
	...
	sfSprite_setTexture(quit, sfTexture_createFromFile("img/quit.png", NULL), 0);
    hunter->quit = quit;
}